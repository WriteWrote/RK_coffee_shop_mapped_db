...
public class OrderControllerTest extends AbstractTestContainer {
	...
	public void getAll() throws Exception {
		...
		var responseOrdersList = objectMapper.readValue(result.getResponse().getContentAsString(), OrderDto[].class); //typereference
		assertNotEquals(0, responseOrdersList.length);
	}
}